 ...
 */
const handleUserChoice = (userChoice, { goBackToBooksMenu, showBooksList, links, REQUEST_LINK }) => {
...
const showBooksList = async (goBackToBooksMenu, pageLink) => {
  ...
  // if (bookSearch) {
  //   REQUEST_LINK = `${NAME_SEARCH_LINK}${bookSearch}`;
  // }
  ...
  //   return showBooksList(goBackToBooksMenu, REQUEST_LINK);
  // }
