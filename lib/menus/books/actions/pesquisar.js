...
const pesquisar = async (goBackToBooksMenu, redlinks) => {
  const { links, books } = first_block(redlinks);
  const userChoice = secound_block(books, links);
